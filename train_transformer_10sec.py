...
# 5개 데이터셋 경로
DATASET_PATHS = [
    "/home/jay/MusicAI/mtg_embeddings_train_10sec",
    "/home/jay/MusicAI/mtt_embeddings_train_10sec", 
    "/home/jay/MusicAI/gtzan_embeddings_train_10sec",
    "/home/jay/MusicAI/gs_embeddings_train_10sec",
    "/home/jay/MusicAI/emo_embeddings_train_10sec"
]
...
def main():
    ...
    # 최종 모델 저장
    final_save_path = "transformer_10sec_mlm.pth"
    torch.save({
        'model_state_dict': model.state_dict(),
        'optimizer_state_dict': optimizer.state_dict(),
        'emb_dim': dataset.emb_dim,
